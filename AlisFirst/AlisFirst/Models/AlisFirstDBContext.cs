...
{
    public class AlisFirstDBContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<AlisFirst.Models.AlisFirstDBContext>());

        public AlisFirstDBContext() : base("name=AlisFirstDBContext")
        {
        }
