...
{
    public class AlisDBInitializer : DropCreateDatabaseIfModelChanges<AliseEFDBContext>
    {
        protected override void Seed(AliseEFDBContext context)
        {
            ...
            var asset = new List<Asset>
            {
                ...
                new Asset 
                {
                    ...
                    CategoryID = 4, SupplierID = 3, AssetModelID = 5
                },
                new Asset 
                {
                ...
                new Asset 
                {
                    ...
                    CategoryID = 4, SupplierID = 3, AssetModelID = 6
                },
                new Asset 
                {
                ...
                new Asset 
                {
                    ...
                    CategoryID = 4, SupplierID = 3, AssetModelID = 7
                }
            };
